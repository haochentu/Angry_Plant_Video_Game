...
class FrameManager(object):
   ...
   class _FM(object):
      ...
      _FRAME_SIZES = {"sunflowers.png": (63,78), "fox.png": (61,54), "otter.png":(38,53), 
                      "cat.png":(68,56), "panda.png":(72,53),
                      "dragon.png":(50,56),
                      "foxweapon.png":(6,6), "pearl.png": (12,12),
                      "catWeapon.png":(20,10), "pandaball": (25,26),
                      "fireball.png": (18,18),
                      "cactus.png":(40,40), "mushroom.png": (25,34),
                      "pumpkin.png":(40,50), "flower.png": (30,40),
                      "dandelion.png":(40,58), "skull.png":(16,20), 
                      "star.png":(100,100)}
      
      # A default frame size
      _DEFAULT_FRAME = (40,40)
      
      # A list of images that require to be loaded with transparency
      _TRANSPARENCY = {}
      
      # A list of images that require to be loaded with a color key
      _COLOR_KEY = ["sunflowers.png", "fox.png", "otter.png",
                    "cat.png", "panda.png", "dragon.png",
                    "foxweapon.png", "pearl.png",
                    "catWeapon.png", "pandaball.png",
                    "fireball.png", "cactus.png", "mushroom.png",
                    "pumpkin.png", "flower.png",
                    "dandelion.png", "skull.png", "star.png"]
