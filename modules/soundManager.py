# -*- coding: utf-8 -*-
"""
Created on Tue Mar 15 20:14:58 2022

sound manager for Angry Plants
"""
...
class SoundManager(object):
   ...
   class _SM(object):
      ...
      _FOLDER = {
         "bullet.wav"     : _SFX_FOLDER,
         "catSword.wav" : _SFX_FOLDER,
         "fireball.wav"     : _SFX_FOLDER,
         "otter.wav"     : _SFX_FOLDER,
         "panda.wav" : _SFX_FOLDER,
         "enemyDeath.wav" : _SFX_FOLDER,
         "start.mp3" : _MUSIC_FOLDER,
         "level1.mp3" : _MUSIC_FOLDER
      }
      ...
      def updateVolumePositional(self, channel, relativePosition, soundPosition, distance=300, minVolume=0.2):
         ...
         if (channel != None and channel.get_busy()):
